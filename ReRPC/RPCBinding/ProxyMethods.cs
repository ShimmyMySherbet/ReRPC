...
#pragma warning disable CS8603 // Possible null reference return.
		...
		{
			public AsyncInvoke(ReRPCClient rPC, string method, Type delegateHandler) : base(rPC, method, delegateHandler)
			{
			}
		...
		{
			public AsyncQuery(ReRPCClient rPC, string method, Type delegateHandler) : base(rPC, method, delegateHandler)
			{
			}
		...
		{
			public BlockingInvoke(ReRPCClient rPC, string method, Type delegateHandler) : base(rPC, method, delegateHandler)
			{
			}
		...
		{
			public BlockingQuery(ReRPCClient rPC, string method, Type delegateHandler) : base(rPC, method, delegateHandler)
			{
			}
